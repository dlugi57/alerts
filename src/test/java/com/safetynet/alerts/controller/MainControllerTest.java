...
class MainControllerTest {
    ...
    static {
        ...
        personsFire.add(new PersonFire("Boyd", "841-874-6513", 31, Arrays.asList("pharmacol:5000mg", "terazine:10mg", "noznazol:250mg"),
                Arrays.asList()));
        personsFire.add(new PersonFire("Boyd", "841-874-6512", 8, Arrays.asList(),
                Arrays.asList("peanut")));
        personsFire.add(new PersonFire("Boyd", "841-874-6512", 3, Arrays.asList(),
                Arrays.asList()));
        personsFire.add(new PersonFire("Boyd", "841-874-6544", 34, Arrays.asList("tetracyclaz:650mg"),
                Arrays.asList("xilliathal")));
    }
